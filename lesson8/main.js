...
// }
//
function UserFullInfo(name, username, email, addressStreet, addressSuite, addressCity, addressZipcode, geoLat, geoLng, phone, website, companyName, companyCatchPhrase, companyBs) {
    this.name = name;
...
let user1 = new UserFullInfo('Leanne Graham', 'Bret', 'Sincere@april.biz', 'Kulas Light', 'Apt. 556',
