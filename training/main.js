...

{
    ...
    const num = parseInt(prompt('Введіть число чотиризначне число'));
    if (num%2===0){
        let string = num + '';
...
{
    // Завдання 9. Чет-непар. Сума та добуток чисел. Користувач вводить через prompt() чотиризначне число. Вам потрібно вивести в консоль,
    // чи є число парним чи непарним, а також знайти добуток його цифр, якщо число парне, або суму його цифр, якщо число непарне.
...
{
    // Завдання 10. Декілька умов. Сходи if...else Попросіть користувача ввести розмір зарплати. Розрахуйте, яку суму він має
...
{
    // Завдання 11. Вивести за допомогою циклу 8-10 подібних зображень (квіти, автомобілі, футболісти, іграшки, чашки), наприклад:
}

{
    // Завдання 12. Підрахуйте суму чисел у діапазоні від 1 до 10 за допомогою циклу for, while та do...while. Підказка: у результаті має вийти 55.
}
