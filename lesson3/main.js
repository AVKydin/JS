...
for (let i = 0; i < usersList.length; i++) {
    document.write(`<div>${usersList[i].name}</div>`)
...
for (let i = 0; i < usersList.length; i++) {
    document.write(`<div>${usersList[i]['email']}</div>`)
}
...
while (i<usersList.length) {
    document.write(`<h1>${usersList[i].name} - fake</h1>`);
    i+=1;
}
...
while (j<usersList.length){
    document.write(`<h1>${usersList[j].company.name}</h1>`);
    j+=1;
}
...
document.write(`<div><h2>status: false</h2></div>`)
for (const user of users) {
    if(!user.status){
        document.write(`<div>${user.name}</div>`)
    }
...
document.write(`<div><h2>віджили своє</h2></div>`)
for (const user of users) {
    if(user.age>30){
        document.write(`<div>${user.name}</div>`)
    }
